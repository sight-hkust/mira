...
class CheckInfo{
  ...
  CheckInfo({this.vision_livingEyeSight, this.vision_bareEyeSight, this.vision_eyeGlasses, this.vision_bestEyeSight, this.opto_diopter, this.opto_astigmatism, this.opto_astigmatismaxis, this.slit_conjunctiva, this.slit_cornea, this.slit_eyelid, this.slit_Hirschbergtest, this.slit_lens, this.slit_chamber});
